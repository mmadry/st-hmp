function [D,Gamma,err,gerr] = ksvdd(params,varargin)
...
for iter = 1:iternum
  ...
  for j = 1:dictsize
    [D(:,p(j)),gamma_j,data_indices,unused_sigs,replaced_atoms] = optimize_atom_bo(data,D,p(j),Gamma,unused_sigs,replaced_atoms);
...
function [atom,gamma_j,data_indices,unused_sigs,replaced_atoms] = optimize_atom_bo(X,D,j,Gamma,unused_sigs,replaced_atoms)
